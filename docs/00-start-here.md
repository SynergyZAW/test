# Safari Smoke — The Drive. Creative package for approval.

**Phase:** design and flow. **Author:** art direction, this session. **For:** Jon.
**Status:** nothing cinematic has been generated. This is the gate the brief asked for.

## What is in this package

| # | File | What it is | What I need from you |
|---|------|------------|----------------------|
| 01 | `01-creative-concept.md` | The idea, the POV, the reveal, and the one rule for putting comic DNA into a 3D world | Approve the rule, the reveal staging, and who the viewer turns out to be |
| 02 | `02-scene-list.md` | Eight chapters, beat by beat, with copy, motion, composition and the mobile recompose | Approve the arc and the copy |
| 03 | `03-character-bible-plan.md` | The one proportion rule, the three rebuilds, the turnaround/expression spec, the device as a fourth locked prop | Approve before I generate a single sheet |
| 04 | `04-impact-library.md` | Twelve reusable hits, each with its motion envelope and its visual asset | Approve the caps and the list |
...
- **A scrollable pre-viz animatic** in `src/`. Same scroll track, same eight chapters, same hits, same blocking, drawn in palette silhouettes. Scroll it on your phone. That is the flow you are approving. It is not the film.
- **The build scaffold**: age gate, scroll engine, shake system with caps, sticky CTA from chapter 2, camp with the range named, proof board with empty slots, analytics stubs, reduced-motion and slow-network stills mode, keyboard path.
- **Badaboom** subsetted and self-hosted. **Atkinson Hyperlegible** as the one quiet sans.
...
Per your note: 9:16 is the master composition. Every scene is designed portrait first and recomposed for 16:9, not the other way round. The animatic already does this: the hand, the mirror, the copy zones and the cast all sit differently in portrait and landscape.

## Frosty plants

Yes, as set dressing, in three places where they cannot fight character consistency. Listed in 02 and 05 as their own locked asset, generated once like the device.
