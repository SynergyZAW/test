...
> | Permanent Marker turnaround v2b (3D look) | Candidate, awaiting Jon (16 Sep) | Same monkey brought down to the ape's height: five heads, bigger head, short torso, long arms, long tail. `docs/sheets/sheet-02-permanent-marker-turnaround-v2b-3d.jpg` |
> | Eco-Star prop v2 (3D look) | Candidate, awaiting Jon (16 Sep) | Per Jon's photo of the natural unit: cream mouthpiece in the same speckled material, pale smooth cream base, no light on the base. Black unit unchanged. `docs/sheets/sheet-04-ecostar-prop-v2-3d.jpg` |
