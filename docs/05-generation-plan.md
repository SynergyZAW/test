...
3. **Lighting and palette keys** — five stills, one per time of day, from the back-row POV with the locked truck: morning, noon, golden hour, dusk/night (the pre-dawn key is retired 16 Sep; the drive starts in daylight). These are the grade reference for every subsequent generation.
